...
%changelog
* Tue Apr 19 2011 Vaibhav Verrma <vverna@nbcs.rutgers.edu> - 2.02-2.ru
- Removed the web component of alpine.
- Added a bunch of options to ./configure for spellcheck, ssl and default pinerc files.
