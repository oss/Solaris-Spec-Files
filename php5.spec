...
Requires: libtool mysql5 > 5.0  mysql5 < 5.0 mm openssl >= 0.9.7e gdbm openldap >= 2.3 gd libmcrypt mysql5 freetype2 openldap-lib >= 2.3 curl expat freetds-lib libxml2 >= 2.6.22 libjpeg >= 6b-11
