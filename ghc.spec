...
# Values for 4.08 and 1 are set by the `configure' script.  
...
#
# I (sbi) modified this a bit to use Happy 1.8 and not build the
# documentation.
...
Source: ghc-%{version}-src.tar.gz
URL: http://haskell.org/ghc/
BuildRoot: /var/tmp/ghc-%{version}-%{release}-root
# Requires: gmp-devel
BuildRequires: happy >= 1.8, ghc
...
comprehensive set of libraries.  Documentation for this package is
