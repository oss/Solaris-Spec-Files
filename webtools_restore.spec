...
Summary: Web application addon that allows users to restore old files or directories
Name: %name
Version: %version
Release: %release
Copyright: GPL
...
%description
Web application addon that allows users to restore old files or directories
