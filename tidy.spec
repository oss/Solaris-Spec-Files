...
# We can't build the api docs. We don't have doxgen on Solaris yet
...
sed -i 's|z text|zdefs|' aclocal.m4
...
%changelog
* Mon Sep 20 2010 Orcan Ogetbil <orcan@nbcs.rutgers.edu> - 0.99.0-1.20100920
- 20100920 snapshot for Solaris 9
