...
# OSS: We don't have a package for this yet
#BuildRequires:   docbook-utils


# OSS: We don't have these 2 packages yet
...
%post
/usr/local/bin/install-info %{_infodir}/gnupg.info %{_infodir}/dir ||:

%preun
if [ $1 -eq 0 ]; then
  /usr/local/bin/install-info --delete %{_infodir}/gnupg.info %{_infodir}/dir ||:
fi
