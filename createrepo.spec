...
Requires: python >= 2.6, rpm-python, rpm >= 4.1.1, libxml2-python
Requires: yum-metadata-parser, yum >= 3.2.23-10
# Disable these
#Requires: python-deltarpm, deltarpm
...
gmake prefix=%{_prefix} mandir=%{_mandir} DESTDIR=$RPM_BUILD_ROOT install
