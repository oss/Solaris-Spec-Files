...
# our python does not understand this syntax
sed -i 's|PyCurlFileObject()|PyCurlFileObject|' urlgrabber/grabber.py
...
rm -rf $RPM_BUILD_ROOT/%{_datadir}/doc/urlgrabber-%{version}
